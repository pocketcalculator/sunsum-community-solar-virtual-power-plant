...
export const DEMO_IDENTITY_IDS = Object.freeze({
  userIds: Object.freeze([
    DEMO_SITE_OWNER_USER_ID, DEMO_OPERATOR_USER_ID, DEMO_INVESTOR_USER_ID,
    DEMO_SITE_OWNER_WEBB_USER_ID, DEMO_SITE_OWNER_THOMPSON_USER_ID, DEMO_SITE_OWNER_BROOKS_USER_ID,
  ]),
  investorIds: Object.freeze([DEMO_INVESTOR_ID]),
});
