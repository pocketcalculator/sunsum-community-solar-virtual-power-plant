  ...
  return <div className={styles.stack}>
    ...
    <section className={styles.panel} aria-label="Current read evidence">
      <ReadFacts items={[
        ...
        { label: "Business workflows", value: "WORKFLOW_WRITES_NOT_IMPLEMENTED" },
      ]} />
    </section>
      ...
      {CONNECTION_REGISTRY.map((connection) => <details className={styles.disclosure} key={connection.id}>
        ...
        <div className={styles.connection}>
          ...
          <ReadFacts items={[
            ...
            { label: "Read operations", value: connection.acceptedOperations.length ? connection.acceptedOperations.join("\n") : "No independent network operation admitted" },
